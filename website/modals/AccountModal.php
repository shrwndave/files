<div class="modal fade bg-black" id="update<?= $user['id'] ?>" >
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<form action="../pages/account.php?function=update&&sub_page=update" method="post">
...
<div class="modal fade bg-black" id="delete<?= $user['id'] ?>" >
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<form action="../pages/account.php?function=delete&&sub_page=deleteUser" method="post">
                                <input type="hidden" value="<?= $user['id'] ?>">
