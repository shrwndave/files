        ...
        <div class="login-row padding-20px marginleft-80px media" style="width:50%; right:50px">
            <div class="card media-margintop-50px bg-transparent padding-50px border-1px-solidwhite " style="height: 500px;width: 700px;">
                <div class="marginleft-80px">
                    <form href="../pages/validate.php?function=register&&sub_page=register" method="POST">
                ...
                <p class="text-underline text-centered font-13px marginbottom-20px color-white">Dont have an account? <a href="../pages/validate.php?sub_page=login"> Log in</a></p>
            </div>
        </div>
    </div>
</body>
