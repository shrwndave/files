            ...
            <div class="card border-1px-solidwhite bg-transparent" style="height: 770px; width: 600px;">
                ...
                <div class="login-form full-width marginleft-47px">
                    <form action="../page/validate.php?sub_page=Home" method="POST">
                        <label class="login-label margin-10px color-white">Email: </label>
                        <br>
                        <input class="login-input margin-10px width-90 padding-4px" type="email" id="email" name="email" required aria-label="Email">>
                        <br>
                        <label class="login-label margin-10px color-white">Password: </label>
                        <br>
                        <input class="login-input margin-10px width-90 padding-4px" type="password" id="password" name="password" required aria-label="Password">
                </div>
                <div class="height-250px full-width padding-20px">
                        <button class="color-white font-15px text-decoration-none width-60 bg-purple border-none marginbottom-20px padding-15px bg-purple marginleft-140px" 
                                type="submit">
                            Login
                        </button>
                    </form> 
                    ...
                    <a href="../page/validate.php?sub_page=register">
