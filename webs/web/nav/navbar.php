<div class="container">
    ...
    <div class="offcanvas offcanvas-end bg-black" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <ul class="navbar-nav marginleft-38px justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
                <a class="nav-link nav-hover color-white <?php echo ($this->page == 'account') ? 'nav-active' : ''; ?>" href="../page/account.php">Accounts</a>
            </li>
          <li class="nav-item dropdown">
            ...
            <li><a class="dropdown-item" href="#">Profile</a></li>
              ...
              <li><a class="dropdown-item" href="../page/validate.php">Logout</a></li>
            </ul>
          </li>
        </ul>
